...
CREATE TABLE `kecamatan` (
  ...
  `kotakab_id` char(4) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `kecamatan` (`id`, `kotakab_id`, `nama`) VALUES
...
ALTER TABLE `kecamatan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `districts_id_index` (`kotakab_id`);
...
--
ALTER TABLE `kecamatan`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`kotakab_id`) REFERENCES `kotakab` (`id`);
COMMIT;
